...
namespace A2_AccessDatabase
{
    class Goat : Animal
    {
        ...
        {
            string details = "Animal Type: Goat |" + " ID: " + ID + " | Weight: " + Weight + " | Amount of water: " + AmountOfWater +
        ...
        public override double getProfit()
        {
            ...
            double income = AmountOfMilk * Utility.goatMilkPrice;
        ...
        public Goat(int id, double amountWater, double dailyCost, double weight, int age, string color, double milkAmount) : base(id, amountWater, weight, age, color, dailyCost)
        {
            this.ID = id;
